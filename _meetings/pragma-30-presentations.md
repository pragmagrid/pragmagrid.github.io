...
<span class="subsection">Joint APAN PRAGMA Session</span>

* [PRAGMA-ENT: Exposing SDN Concepts to Domain Scientists in the Pacific Rim][46], 
  Kohei Ichikawa (NAIST, Japan), Matthew Collins (University of Florida, USA)
* [Biodiversity Expedition: Virtualizing Lifemapper][47], Nadya Williams (UCSD, USA)
* [A "Room Scheduler" for running experiments across the PRAGMA multi-cloud environment][48],
  Shava Smallen (UCSD, USA)
* [Pacific Rim Application and Grid Middleware Assembly (PRAGMA) Overview][49],
  Phil Papadopoulos (UCSD, USA)

<br>

#### <span class="strongword">January 28</span>

* **Welcome Message from the Local Host**, Denis Villorente, ASTI
* [PRAGMA Updates][20], Peter Arzberger, PRAGMA Chair
* **Keynote Message**, Prof. Sureswaran Ramadass, Former APAN Chair
* **Working Group Updates**
  * [Resources][10]
  * [Bioscience][11]
  * [Telescience][12]
* **Demos**
  * [Agent-Based Transport Simulation Model for Disaster Response Vehicles][17], 
    Elvira Yaneza, Xavier University, Philippines
  * [Distcloud Distributed File System for Resilient Global Services][18],
    Ikuo Nakagawa, Osaka University
  * [Toward Flexible and Efficient Computing Resource Service by SDN-enhanced 
    Job Management System Framework][19], Yasuhiro Watashiba, NAIST
* [Joint APAN and PRAGMA Plenary][16]

* **Poster Session**
  * [Thermophysical Properties from Nucleation Simulations][21], Zamantha Nadir Z. Martin
  * [Student Presentation Computational Search for Druggable Sites: Solvation and
    Structural Studies on 3ZR9 New Delhi Metallo-beta-lactamase, NDM-1][22], Mark Anthony P. Lim
  * [In silico Characterization of the Venus Flytrap Module of Venus Kinase
    Receptors from Various Sources][23], Darwin C. Gomez
  * [Molecular Dynamics Study on Engineered Industrially Important
    Proteins][24], Adam Jo    Elatico
  * [Updates on Studies in the Seven Lakes, Philippines][25], Teresita Perez
  * [Operation Weather Research and Forecasting (WRF) in
    ASTI: Making forecast data accessible for disaster risk
    reduction and scientific research][26], Jay Samuel Combinido
  * [Evaluation of Multipath TCP(s) response to latency
    in wide-area software-defined networks][27], Chawanat Nakasan
  * [Wireless Network Sensing and UAV Imaging as
    Resource Management Support for Philippine Lakes][28], Dominic Solpico
  * [Practicality and Feasibility of Improving Linux
    Container Utilization with Task Rebalancing Strategy ][29], Pongsakorn U-chupala
  * [Information and Communications Technology Resources
    of Credit Cooperatives in a Highly Urbanized City][30], Lemuel Clark Velasco
  * [RDA-PRAGMA Sprint - Biodiversity Model Replay][31], Quan Zhou
  * [Data Visualization of Schistosomiasis Community
    Health Data Using Google Maps and Google Charts][32], Lemuel Clark Velasco
  * [Bio-physical Monitoring of Lake Buhi, Camarines
    Sur using Environmental Gradients, Fish and
    Phytoplankton Diversity, Abundance and Distribution][33], Alvin Baloloy
  * [Enabling Philippine Farmers to Adapt to Climate Variability Using
    Seasonal Climate and Weather Forecast with a Crop Simulation Model
    in an SMS-based Farmer Decision Support System][34], Rhia Trogo-Pantola
  * Variant Calling for 3024 Rice Genomes on IR64 Reference, Detras Jeffrey 
  * Structural variant discovery in 3,024 rice genomes, Roven Rommel Fuentes
  * Graph-Theoretic Approach on IP Address Autoconfiguration in Manet, Shehab Ibrahim
  * Simulation of the Aerosol Feedback Effect to Metro Manila
    AirsheD Climate Using WRF/CHEM, Mark Daryl Ramos
  * Smart Socket, Jay Ventura
